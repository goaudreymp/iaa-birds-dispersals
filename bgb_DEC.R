setwd("/mnt/data/dayhoff/home/u6562250/dispersals")
...
BioGeoBEARS_run_object$distsfn = "distances_calc_min&touch1.txt"
...
BioGeoBEARS_run_object$num_cores_to_use = 15
BioGeoBEARS_run_object$force_sparse = FALSE    # force_sparse=TRUE causes pathology & isn't much faster at this scale
